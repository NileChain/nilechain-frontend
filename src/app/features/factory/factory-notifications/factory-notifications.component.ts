...
export class FactoryNotificationsComponent {
  readonly tabs = [
    { key: 'all', labelKey: 'notifications.all', active: true, icon: null as string | null },
    { key: 'unread', labelKey: 'notifications.unread', active: false, icon: null as string | null },
    { key: 'matches', labelKey: 'notifications.matches', active: false, icon: 'hub' },
    { key: 'risks', labelKey: 'notifications.risks', active: false, icon: 'warning' },
  ] as const;
